...
export const Earth: React.FC<EarthProps> = ({ w = 24, h = 24, color = "#404040" }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={w} height={h} viewBox="0 0 26 26" fill="none">
      <path d="M2.16669 13C2.16669 18.9833 7.01677 23.8334 13 23.8334C18.9833 23.8334 23.8334 18.9833 23.8334 13C23.8334 7.01677 18.9833 2.16669 13 2.16669C7.01677 2.16669 2.16669 7.01677 2.16669 13Z" stroke={color} stroke-width="1.5" stroke-linecap="round" strokeLinejoin="round" />
